...
android {
    namespace = "com.zakgof.table.examples"
    ...
    defaultConfig {
        applicationId = "com.zakgof.tabledemo"
...
compose.desktop {
    ...
    application {
        mainClass = "com.zakgof.table.examples.MainKt"
        ...
        nativeDistributions {
            ...
            packageName = "com.zakgof.table"
            packageVersion = "1.0.1"
            modules("jdk.unsupported")
            windows {
                iconFile.set(project.file("table.png"))
            }
            linux {
                iconFile.set(project.file("table.png"))
            }
